...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <section
        id="home"
        className="relative min-h-170 sm:min-h-180 flex items-center justify-center overflow-visible bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage:
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                <div className="relative border border-gray-200 rounded-xl p-3 hover:border-blue-400 transition">
                  ...
                  <input
                    ...
                    className="w-full font-semibold text-gray-800 outline-none bg-transparent text-sm placeholder:text-gray-400 cursor-text"
                  />
                  ...
                  {showFromDropdown && fromSearch && (
                    <div className="absolute z-50 left-0 right-0 top-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl max-h-64 overflow-y-auto">
                      {filteredFromAirports.length > 0 ? (
                        filteredFromAirports.map((airport) => (
                          <button
                            ...
                            className="w-full text-left px-4 py-3 hover:bg-blue-50 transition border-b border-gray-100 last:border-b-0 cursor-pointer"
                          >
                ...
                <div className="relative hidden lg:flex items-center justify-center -mx-2 z-10">
                  <button
                    ...
                    className="absolute w-10 h-10 rounded-full bg-white border border-gray-200 shadow-md flex items-center justify-center text-blue-600 hover:bg-blue-50 hover:border-blue-400 hover:shadow-lg transition cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    ⇄
                  </button>
                </div>
                ...
                >
                  ...
                  {tripType === "ONE_WAY" ? (
                    ...
                    <input
                      ...
                      className="w-full font-semibold text-gray-800 outline-none bg-transparent cursor-pointer disabled:cursor-not-allowed"
                    />
                  )}
                </div>
              </div>
              ...
              <div className="mt-4 flex flex-col sm:flex-row gap-3">
                <div className="relative w-full sm:w-55">
                  <button
                    ...
                    className="w-full h-13 border border-gray-200 rounded-xl px-3 flex items-center justify-between bg-white hover:border-blue-400 transition cursor-pointer"
                  >
                  ...
                  {travelerOpen && (
                    <div className="absolute z-50 mt-2 w-full sm:w-70 bg-white rounded-xl shadow-2xl border border-gray-200 p-4">
                      <div className="flex items-center justify-between py-3">
                        ...
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="w-8 h-8 rounded-full border border-gray-300 text-lg hover:bg-gray-100 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                          ...
                          <button
                            ...
                            className="w-8 h-8 rounded-full border border-gray-300 text-lg hover:bg-gray-100 cursor-pointer"
                          >
                            +
                          </button>
                        </div>
                      ...
                      <button
                        ...
                        className="w-full mt-3 h-9 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 cursor-pointer"
                      >
                        Done
                      </button>
                    </div>
                    ...
                    <div className="absolute z-50 mt-2 w-full bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
                      {[
                        ...
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 text-sm hover:bg-blue-50 transition cursor-pointer ${
                            cabin === cabinOption
                ...
                <button
                  type="button"
                  className="relative w-full sm:w-75 h-13 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl font-semibold flex items-center justify-center gap-2 transition shadow-lg ml-0 sm:ml-20 md:ml-40 lg:ml-95 cursor-pointer"
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6">
          ...
          <Link
            to="/home"
            className="inline-flex items-center gap-2 mt-8 px-7 py-3 bg-white text-blue-600 rounded-xl font-bold hover:bg-blue-50 transition cursor-pointer"
          >
            Book a Flight
            <FiArrowRight />
          </Link>
