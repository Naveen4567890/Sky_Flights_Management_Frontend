...
const BookingReview = () => {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 shadow-lg p-6 sm:p-8 text-center">
          ...
          <button
            ...
            className="w-full mt-6 h-11 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition"
          >
            Go to Flights
          </button>
        </div>
  ...
  const handleProceedToPayment = () => {
    ...
    const returnSeats = selectedReturnFlight
      ? confirmSeat?.[selectedReturnFlight.id] || []
      : [];

    if (onwardSeats.length !== passengers.length) {
      toast.error(
    ...
    const bookingPassengers = passengers.map(
      (passenger, index) => ({
        ...
        onwardSeatNumber: onwardSeats[index],
        returnSeatNumber: selectedReturnFlight
          ? returnSeats[index]
          : null,
        cabin:
          passenger.cabin ||
    ...
    dispatch(setPassengers(bookingPassengers));

    toast.success("Booking details ready for payment");
    navigate("/payment");
  };
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-500 mt-1">
                Check your flight and passenger details before payment
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sm:p-6">
                ...
                <div className="mt-6 space-y-3">
                  <button
                    ...
                    className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-md transition"
                  >
                    Proceed to Payment →
                  </button>
                  ...
                  <button
                    ...
                    className="w-full h-11 border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-xl transition"
                  >
